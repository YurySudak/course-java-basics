...
public class Task06 {
    ...
    public static void main(String[] args) {
        ...
        int scoreFirstPlayer = tanksKilledFirstPlayer * 100;
        int scoreSecondPlayer = tanksKilledSecondPlayer * 100;
        if (tanksKilledFirstPlayer > tanksKilledSecondPlayer) scoreFirstPlayer += 500;
        else if (tanksKilledFirstPlayer < tanksKilledSecondPlayer) scoreSecondPlayer += 500;
        System.out.println("Player 1: " + scoreFirstPlayer + ". Player 2: " + scoreSecondPlayer);
    }
}